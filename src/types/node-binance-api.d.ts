declare module "node-binance-api" {
  ...
  export interface IWebsocketsMethods {
    userData(
      call_updates_callback?: Callback,
      balance_callback?: Callback,
      subscribedCallback?: Callback,
      list_statusCallback?: Callback
    ): any;
    userMarginData(
      call_updates_callback?: Callback,
      balance_callback?: Callback,
    ...
    userFutureData(
      all_updates_callback?: Callback,
      margin_callCallback?: Callback,
      account_updateCallback?: Callback,
      order_updateCallback?: Callback,
      subscribedCallback?: Callback
    ): any;
    userDeliveryData(
      all_updates_callback?: Callback,
  ...
  export default class Binance {
    ...
    futuresMarkPrice(
      symbol?: string,
      params?: Dict
    ): Promise<PremiumIndex | PremiumIndex[]>;
    /**
    ...
    futuresCancelAll(
      symbol: string,
      params?: Dict
    ): Promise<FuturesCancelAllOpenOrder[]>;
    /**
     *
     * @param symbol symbol if the market
     * @param countdownTime
     ...
     * @returns
     */
    futuresChangePositionSideDual(
      dualSidePosition: any,
      params?: Dict
    ): Promise<any>;
    /**
     *
    ...
    deliveryLeverageBracketSymbols(
      symbol?: string,
      params?: Dict
    ): Promise<any>;
    deliveryLeverage(
    ...
    deliveryChangePositionSideDual(
      dualSidePosition: any,
      params?: Dict
    ): Promise<any>;
    /**
 ...
 */
     ...
     */
    userData(
      all_updates_callback?: Function,
      balance_callback?: Callback,
      execution_callback?: Callback,
      subscribed_callback?: Callback,
      list_status_callback?: Callback
    ): void;
    /**
    ...
    userFutureData(
      ...
      subscribed_callback?: Callback,
      account_config_update_callback?: Callback
    ): void;
    /**
